...
const Details = ({ postion, company, companyLink, time, address, work }: any) => {
    return (
        <li className='my-6 first:mt-0 last:mb-0 w-full mx-auto flex flex-col items-start justify-between text-left bg-gray-100 rounded-2xl p-4 md:p-10'>
            ...
            <hr className='w-1/4 border-cyan-900 my-4 ' />
            <ul className='text-md font-normal w-full list-disc m-4'>
                {
                    work.map((item: any) => {
